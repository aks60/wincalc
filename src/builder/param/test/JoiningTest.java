...
public class JoiningTest extends ParamTest {
    ...
    public void joiningVar() {
        ...
        assert true == joiningVar2.check(iwin_2.mapJoin.get(frame_left_2.joinPoint(1)), param("30", grup)) : grup;
        assert false == joiningVar2.check(iwin_2.mapJoin.get(frame_left_2.joinPoint(1)), param("32", grup)) : grup;
        ...
        assert true == joiningVar2.check(iwin_2.mapJoin.get(frame_left_3.joinPoint(1)), param("2,45", grup)) : grup;
        assert true == joiningVar2.check(iwin_2.mapJoin.get(frame_left_3.joinPoint(1)), param("2,0-3,0", grup)) : grup;
        assert false == joiningVar2.check(iwin_2.mapJoin.get(frame_left_3.joinPoint(1)), param("2,0", grup)) : grup;
...
//        assert false == joiningDet2.check(mapParam, iwin_2.mapJoin.get(frame_right_2.joinPoint(1)), param("XXX", grup)) : grup;
        ...
        assert true == joiningDet3.check(mapParam, iwin_2.mapJoin.get(frame_right_3.joinPoint(1)), param("32", grup)) : grup;
