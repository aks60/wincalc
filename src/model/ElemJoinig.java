...
public class ElemJoinig {
    ...
    public void initJoin() {
        ...
        if (elemJoinLeft == null && elemJoinRight != null && elemJoinBottom != null && elemJoinTop == null) { 
            name = "Угловое соединение левое верхнее";
        ...
        } else if (elemJoinLeft == null && elemJoinRight != null && elemJoinBottom == null && elemJoinTop != null) {
            name =  "Угловое соединение левое нижнее";
            ...
            name = "Угловое соединение правое верхнее";
        ...
        } else if (elemJoinLeft != null && elemJoinRight == null && elemJoinTop != null && elemJoinBottom == null) { 
            name = "Угловое соединение правое нижнее";
            joinElement2 = elemJoinLeft;
            joinElement1 = elemJoinTop;
            varJoin = VariantJoin.VAR2;
        ...
        } else if ((elemJoinLeft != null && elemJoinBottom != null && elemJoinRight != null && elemJoinTop == null) && elemJoinLeft.equals(elemJoinRight)) { 
            name = "T - соединение верхнее";
            joinElement2 = elemJoinLeft;
            joinElement1 = elemJoinBottom;
            varJoin = VariantJoin.VAR4;
            elemJoinBottom.setAnglCut(ElemBase.SIDE_START, cutAngl1);

        } else if (elemJoinLeft != null && elemJoinTop != null && elemJoinRight != null && elemJoinBottom == null && elemJoinLeft.equals(elemJoinRight)) { 
            name = "T - соединение нижнее";
            joinElement1 = elemJoinTop;
            joinElement2 = elemJoinLeft;
            varJoin = VariantJoin.VAR4;
            elemJoinTop.setAnglCut(ElemBase.SIDE_END, cutAngl1);

        } else if (elemJoinLeft == null && elemJoinTop != null && elemJoinRight != null && elemJoinBottom != null && elemJoinTop.equals(elemJoinBottom)) { 
            name = "T - соединение левое";
